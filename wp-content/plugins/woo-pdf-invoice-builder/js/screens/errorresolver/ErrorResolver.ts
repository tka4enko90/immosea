...
class ErrorResolver{
   ...
   constructor(){
    ...
    private Analyze() {
        ...
        jQuery.post(ajaxurl,{action:'rednao_wcpdfinv_diagnose_error',invoiceId:jQuery('#templateName').val(),testType:jQuery('.issueType:checked').val(),orderNumber:jQuery('#orderNumber').val()},(response)=>{
